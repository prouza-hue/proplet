...
app = replace_once(app, "const APP_VERSION='3.30.0-preview.1';", "const APP_VERSION='3.31.0-preview.1';", 'app version')
server = replace_once(server, 'APP_VERSION = "3.30.0-preview.1"', 'APP_VERSION = "3.31.0-preview.1"', 'server version')
sw = replace_once(sw, "const CACHE='proplet-v3.30.0-preview.1-rolling-content';", "const CACHE='proplet-v3.31.0-preview.1-starter-coach';", 'sw cache')

# Remove the passive explanatory onboarding screen. The same principle is taught in the starter itself.
...
# Starter instructions live above the board rather than in the tiny control text under it.
...
# Add the coach panel directly above the board. Hidden for every normal game mode.
...
/* v3.31 preview — starter coach: instructions must win the visual hierarchy. */
...
'''
if 'v3.31 preview — starter coach' in css:
...
print('v3.31 preview starter coach patch applied')
