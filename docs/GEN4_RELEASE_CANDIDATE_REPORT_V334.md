...
- Metadata-only catalog: 4,594 unique contents and 4,599 contexts.
...
1. Reproduce the complete candidate in GitHub Actions.
2. Deploy the paused candidate to Vercel Preview only.
3. Rehearse catalog seed/backfill and migration verification outside production.
4. Smoke-test Free, Daily, Rolling-disabled behavior, progress transfer, archived challenge fallback and cache headers.
