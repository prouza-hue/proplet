...
function renderProfile(){
 ...
 if(!p){
  ...
  setTimeout(()=>{
   ...
   $$('.avatar-choice').forEach(b=>b.onclick=()=>saveAvatar(b.dataset.avatar));refreshAdminEntry();
  },0);
 }
