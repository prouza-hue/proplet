#!/usr/bin/env python3
"""Focused regressions for v3.20.2 account-without-team UX."""
...
if __name__=='__main__':
    ...
    print('PASS: v3.20.2 server account/team compatibility and analytics')
