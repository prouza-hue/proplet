...
for token in ["mode==='starter'",'starterAwaitingHint','starterGuidePath','starter_hint_used','starter_completed','wrongPath','word.length<4','undoSnapshot','showGameUndo','board-complete','await sleep','showStarterDailyNudge']:
