...
def test_health():
    ...
    assert h['version']=='3.22.2'
    assert h['darkModeSprint']=='3.22' and h['darkFoundTextHotfix'] is True and h['darkFoundChipTextHotfix'] is True
...
def test_product_event_version():
    ...
    assert inserted[0][1]['app_version']=='3.22.2'

if __name__=='__main__':
    test_health(); test_product_event_version(); print('PASS: v3.22.2 server health/version')
