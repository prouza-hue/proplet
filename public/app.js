...
function tajenkaFixtureValid(data){
 if(!data||data.version!==1||!/^tajenka-week-\d{2}$/.test(data.id)||data.kind!=='weekend_bonus'||data.meta?.previewOnly!==true||Number(data.meta?.rewardXp)!==TAJENKA_REWARD_XP)return false;
