(()=>{
  ...
  const install=()=>{
    ...
    try{
      if(typeof startGame!=='function'||typeof finishGame!=='function'||typeof performPostWinAction!=='function'||typeof startStarter!=='function'||typeof shareDaily!=='function')return false;
      baseStartGame=startGame;baseFinishGame=finishGame;basePerformPostWinAction=performPostWinAction;baseStartStarter=startStarter;baseShareDaily=shareDaily;
