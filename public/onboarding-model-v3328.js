(()=>{
  ...
  const principleStep={
    ...
    html:`<div class="onboard-content onboard-principle"><span class="eyebrow">JAK FUNGUJE PROPLET</span><h2>Jedna deska. Jedno řešení.</h2><div class="principle-visual" aria-hidden="true"><div class="principle-decoy"><strong>STÁJ</strong><small>✓ české slovo</small></div><div class="principle-not-equal">≠</div><div class="principle-solved"><div class="mini-solved-board"><span class="mini-word mini-word-a">M</span><span class="mini-word mini-word-a">R</span><span class="mini-word mini-word-a">A</span><span class="mini-word mini-word-a">K</span><span class="mini-word mini-word-b">O</span><span class="mini-word mini-word-b">K</span><span class="mini-word mini-word-b">N</span><span class="mini-word mini-word-b">O</span><span class="mini-word mini-word-c">B</span><span class="mini-word mini-word-c">O</span><span class="mini-word mini-word-c">T</span><span class="mini-word mini-word-c">A</span><span class="mini-word mini-word-d">A</span><span class="mini-word mini-word-d">U</span><span class="mini-word mini-word-d">T</span><span class="mini-word mini-word-d">O</span></div><small>řešení vyplní plochu</small></div></div><p class="principle-copy">Na desce najdeš i jiná slova. <strong>Do řešení patří jen ta, která společně vyplní celou plochu.</strong></p></div>`
  };
