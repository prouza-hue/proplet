(()=>{
  ...
  const loadExtras=async()=>{
    ...
    loadScript('/home-layout.js?v=fold12','propletHomeLayout');
    ...
    loadScript('/game-layout-v3330.js?v=fold12','propletGameLayout');
    ...
    loadScript('/challenge-cta-v3333.js?v=fold12','propletChallengeCtaV3333');
