(()=>{
  ...
  const loadExtras=async()=>{
    ...
    loadScript('/home-layout.js?v=fix17','propletHomeLayout');
    ...
    loadScript('/game-layout-v3330.js?v=fix17','propletGameLayout');
    ...
    loadScript('/challenge-cta-v3333.js?v=fix17','propletChallengeCtaV3333');
