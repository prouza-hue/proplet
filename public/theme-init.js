(()=>{
  ...
  const loadExtras=async()=>{
    ...
    loadScript('/home-layout.js?v=fold14','propletHomeLayout');
    ...
    loadScript('/game-layout-v3330.js?v=fold14','propletGameLayout');
    ...
    loadScript('/challenge-cta-v3333.js?v=fold14','propletChallengeCtaV3333');
