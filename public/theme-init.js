(()=>{
  ...
  const loadExtras=async()=>{
    ...
    loadScript('/home-layout.js?v=fix16','propletHomeLayout');
    ...
    loadScript('/game-layout-v3330.js?v=fix16','propletGameLayout');
    ...
    loadScript('/challenge-cta-v3333.js?v=fix16','propletChallengeCtaV3333');
