...
assert(!/window\.fetch\s*=/.test(accountTeam),'account-team still monkey-patches window.fetch');
assert(!/window\.fetch\s*=/.test(recoveryGuard),'recovery guard still monkey-patches window.fetch');
