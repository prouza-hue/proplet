...
# v4.01.2 keeps the approved CTA colour and matches the larger primary type size.
# Its one-time navigation repairs the already-activated v4.00.1 update handover.
assert 'version:\'4.01.2\'' in runtime
assert "proplet-v4.01.2-shell" in sw
...
print("Proplet v4.01.2 quality release contract: OK")
