...
for name in ("privacy.html", "terms.html"):
    ...
    assert '<script src="/theme-init.js?v=40114"></script>' in page, f"{name} must retain a cache-busted theme setup"
...
print("v4.01.14 legal page isolation and cache-bust regression passed")
