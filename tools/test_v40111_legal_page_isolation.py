...
for name in ("privacy.html", "terms.html"):
    ...
    assert '<script src="/theme-init.js?v=40119"></script>' in page, f"{name} must retain a cache-busted theme setup"
...
print("v4.01.19 legal page isolation and cache-bust regression passed")
