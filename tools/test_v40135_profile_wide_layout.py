...
assert 'APP_VERSION = "4.01.35"' in (ROOT / "proplet_version.py").read_text(encoding="utf-8")
assert "version:'4.01.35'" in runtime
...
print("PASS: v4.01.35 wide profile alignment")
