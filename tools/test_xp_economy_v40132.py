...
assert "function renderRunWinXp" in app
assert "g.winBaseXpAwarded=" in app
assert "renderRunWinXp(g)" in app
assert "renderRunWinXp(g)" in feedback
assert "attemptId:candidate.game?.attemptId||null" in feedback
